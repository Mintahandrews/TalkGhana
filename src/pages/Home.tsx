...
const Home: React.FC = () => {
  ...
  const [statusMessage, setStatusMessage] = useState({
    type: "success" as "success" | "error" | "online" | "processing",
    message: "",
    visible: false,
  });
  ...
  const handleEmergencyAction = () => {
    ...
    // Navigate to emergency screen or activate emergency mode
  };
  ...
  return (
    <>
      {/* New TalkGhana Components */}
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">TalkGhana</h1>
          <p className="text-xl text-gray-600">
            Speech synthesis and recognition for Ghanaian languages
          </p>
        </div>
